...
o:value("https://neodev.team/lite_dnsmasq.conf", translate("NEO DEV HOST Lite"))
o:value("https://neodev.team/dnsmasq.conf", translate("NEO DEV HOST Full"))
o:value("https://anti-ad.net/anti-ad-for-dnsmasq.conf", translate("anti-AD"))
o.default = "https://neodev.team/lite_dnsmasq.conf"
o:depends("adblock", "1")
